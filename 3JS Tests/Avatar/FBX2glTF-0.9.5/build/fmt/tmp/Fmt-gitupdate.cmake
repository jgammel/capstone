...
execute_process(
  COMMAND "/usr/bin/git" show-ref 4.0.0
  WORKING_DIRECTORY "/Users/jgammel/Desktop/Harvard/Thesis/Working Files/3JS Tests/Avatar/FBX2glTF-0.9.5/build/fmt/src/Fmt"
...
if("${show_ref_output}" MATCHES "refs/remotes/4.0.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "4.0.0")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 4.0.0
  WORKING_DIRECTORY "/Users/jgammel/Desktop/Harvard/Thesis/Working Files/3JS Tests/Avatar/FBX2glTF-0.9.5/build/fmt/src/Fmt"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/jgammel/Desktop/Harvard/Thesis/Working Files/3JS Tests/Avatar/FBX2glTF-0.9.5/build/fmt/src/Fmt/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/jgammel/Desktop/Harvard/Thesis/Working Files/3JS Tests/Avatar/FBX2glTF-0.9.5/build/fmt/src/Fmt/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
